...
if ! exists("g:terroo_gui_italic")
    let g:terroo_gui_italic = 1
endif

if ! exists("g:terroo_term_italic")
    let g:terroo_term_italic = 0
endif

let g:terroo_termcolors = 256 " does not support 16 color term right now.
...
function! s:h(group, style)
  ...
  if g:terroo_term_italic == 0
    let s:ctermformat = substitute(s:ctermformat, ",italic", "", "")
    let s:ctermformat = substitute(s:ctermformat, "italic,", "", "")
    let s:ctermformat = substitute(s:ctermformat, "italic", "", "")
  endif
  if g:terroo_gui_italic == 0
    let s:guiformat = substitute(s:guiformat, ",italic", "", "")
    let s:guiformat = substitute(s:guiformat, "italic,", "", "")
    let s:guiformat = substitute(s:guiformat, "italic", "", "")
  endif
  if g:terroo_termcolors == 16
